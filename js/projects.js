...
// =============================================
// PROJECT GALLERY
// Infinite desktop slider + mobile swipe gallery
// =============================================
...
function initGallery() {
    ...
    if (!galleryGrid || !project.gallery || !project.gallery.length) {
        return;
    }
    ...
    if (isMobile) {
        ...
        galleryWrapper
            ?.querySelector('.gallery-mobile-controls')
            ?.remove();
        ...
        if (galleryWrapper) {
            ...
            const controlsHTML = `
                <div class="gallery-mobile-controls">
                    ...
                    <span class="gallery-mobile-counter">
                        (1/${totalItems})
                    </span>

                    <div class="gallery-mobile-progress">
                        <div
                            class="gallery-mobile-progress-bar"
                            style="width:${(1 / totalItems) * 100}%"
                        ></div>
                    </div>
        ...
        function showMobileImage(index, direction) {
    ...
    /*
        ...
        We create clones on BOTH sides.
        ...
        Real images start at index 1.

        This allows us to move continuously in either
        direction without ever reaching empty space.
    */
    ...
    // ---------------------------------------------
    // Create clones before real images
    // ---------------------------------------------

    for (let i = 0; i < cloneCount; i++) {

        const sourceIndex =
            (totalItems - cloneCount + i) % totalItems;

        beforeImages.push(project.gallery[sourceIndex]);

    }

    // ---------------------------------------------
    // Create clones after real images
    // ---------------------------------------------
    ...
    for (let i = 0; i < cloneCount; i++) {
        ...
        afterImages.push(project.gallery[sourceIndex]);

    }

    // ---------------------------------------------
    // Build complete infinite track
    // ---------------------------------------------
    ...
    galleryGrid.innerHTML = allImages.map(
        (img, index) => `
            <div
                class="gallery-item"
    ...
    function getStep() {
        ...
        const computedStyle =
            window.getComputedStyle(galleryGrid);
    ...
    function moveGallery(direction) {
        ...
        */
        ...
        galleryGrid.style.transform =
            `translate3d(-${currentTrackIndex * step}px, 0, 0)`;
        ...
        const handleTransitionEnd = (event) => {
            ...
            galleryGrid.removeEventListener(
                'transitionend',
                handleTransitionEnd
            );
            ...
            /*
                We have moved into the clones.

                Reset to the corresponding REAL image
                WITHOUT animation.

                This makes the loop appear continuous.
            */
            ...
            if (
                ...
                galleryGrid.style.transform =
                    `translate3d(-${currentTrackIndex * resetStep}px, 0, 0)`;
            ...
            // -------------------------------------
                ...
                currentTrackIndex < cloneCount
            ) {

                currentTrackIndex =
                    cloneCount + totalItems - 1;
            ...
            /*
                ...
                before allowing the next click.
            */
